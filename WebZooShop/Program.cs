...
using WebZooShop.Mapper;
using WebZooShop.Middleware;
using WebZooShop.Servise;
using WebZooShop.Settings;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebZooShop", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "WebZooShop v1");
