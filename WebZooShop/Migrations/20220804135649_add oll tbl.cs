...
{
    public partial class addolltbl : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblInventoryStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_tblProducts_tblInventoryStatus_InventoryStatusId",
                        column: x => x.InventoryStatusId,
                        principalTable: "tblInventoryStatus",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblProducts_InventoryStatusId",
                table: "tblProducts",
